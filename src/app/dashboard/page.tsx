    ...
    <div className="relative min-h-screen pt-24 pb-16 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          {/* WhatsApp Group Link */}
          <div className="border-t border-border/50 bg-black/20 p-6 flex justify-center mt-auto">
            <a 
              href="https://chat.whatsapp.com/LeuxA49wWUqEtajrmyuRJt" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-emerald-400 hover:text-emerald-300 font-bold text-sm tracking-wider uppercase transition-colors hover:scale-105 active:scale-95"
            >
